...
//! HOSTNAME: `xiefandeiMac.local`, CPU: `<UNKNOWN>`
...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
	...
	fn create_claim(_d: u32, ) -> Weight {
		...
		Weight::from_parts(29_377_420, 3528)
	...
	fn revoke_claim(_d: u32, ) -> Weight {
		...
		Weight::from_parts(27_523_509, 3528)
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
	/// Storage: PoeModule Proofs (r:1 w:1)
	...
	fn transfer_claim(d: u32, ) -> Weight {
		...
		Weight::from_parts(18_440_239, 3528)
			// Standard Error: 26_342
			.saturating_add(Weight::from_parts(126_783, 0).saturating_mul(d.into()))
			.saturating_add(T::DbWeight::get().reads(1_u64))
			.saturating_add(T::DbWeight::get().writes(1_u64))
	}
}
